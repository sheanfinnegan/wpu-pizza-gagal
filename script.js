function isiContentMenu() {
    $.getJSON("pizza.json", function (data) {
        ...
        $.each(dataPizza, function (i, data) {
            $('#daftar-menu').append('<div class="col-lg-4 d-flex justify-content-center"><div class="card mb-5 shadow-lg border border-dark border-2" style="width: 18rem;"><img src="img/pizza/' + data.gambar + '" class="card-img-top"><div class="card-body"><h5 class="card-title">' + data.nama + '</h5><p class="card-text">' + data.deskripsi + '</p><p>Rp. ' + data.harga + ',-</p><a href="#" class="btn btn-primary">Beli Sekarang</a></div></div></div>');
        })
    });
}
    ...
    $.getJSON("pizza.json", function (data) {
        ...
        $.each(dataPizza, function (i, data) {
            if (data.kategori == isiNav.toLowerCase()) {
                content += '<div class="col-lg-4 d-flex justify-content-center"><div class="card mb-5 shadow-lg border border-dark border-2" style="width: 18rem;"><img src="img/pizza/' + data.gambar + '" class="card-img-top"><div class="card-body"><h5 class="card-title">' + data.nama + '</h5><p class="card-text">' + data.deskripsi + '</p><p>Rp. ' + data.harga + ',-</p><a href="#" class="btn btn-primary">Beli Sekarang</a></div></div></div>'
            }
